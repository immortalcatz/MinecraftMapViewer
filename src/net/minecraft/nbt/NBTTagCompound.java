...
public class NBTTagCompound extends NBTBase {
	...
	void write(DataOutput par1DataOutput) throws IOException {
		Iterator<NBTBase> iterator = tagMap.values().iterator();
	...
	public byte getByte(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 1,
			// classcastexception));
	...
	public short getShort(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 2,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	...
	public int getInteger(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 3,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	...
	public long getLong(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 4,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	...
	public float getFloat(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 5,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	...
	public double getDouble(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 6,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	...
	public String getString(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 8,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	...
	public byte[] getByteArray(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 7,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	 ...
	 * empty NBTTagCompound if no such key was
	 * stored.
	 */
	...
	public NBTTagList getTagList(String par1Str) {
		try {
			...
			// throw new ReportedException(this.createCrashReport(par1Str, 9,
			// classcastexception));
			throw new RuntimeException();
		}
	}
	 ...
	 * key was stored. This uses the getByte
	 * method.
	 */
	...
	public String toString() {
		...
		for (Iterator<String> iterator = tagMap.keySet().iterator(); iterator.hasNext(); s = s + s1 + ":" + tagMap.get(s1) + ",") {
			s1 = iterator.next();
		}
	...
	// */
	// private CrashReport createCrashReport(String par1Str, int par2,
	// ClassCastException par3ClassCastException)
	// {
	// CrashReport crashreport =
	// CrashReport.makeCrashReport(par3ClassCastException, "Reading NBT data");
	// CrashReportCategory crashreportcategory =
	// crashreport.makeCategoryDepth("Corrupt NBT tag", 1);
	// crashreportcategory.addCrashSectionCallable("Tag type found", new
	// CallableTagCompound1(this, par1Str));
	// crashreportcategory.addCrashSectionCallable("Tag type expected", new
	// CallableTagCompound2(this, par2));
